...
import { DEVICE_ANDROID_KIOSK_ENABLED_CONFIG_KEY, POS_AUTO_PRINT_ENABLED_CONFIG_KEY, POS_CASH_MANAGEMENT_MODE_CONFIG_KEY, POS_CHECK_ORDER_MANAGEMENT_MODE_CONFIG_KEY, POS_CHECK_ORDER_MANAGEMENT_MODE_MANAGE, POS_CHECK_ORDER_TYPE_CONFIG_KEY, POS_CHECK_ORDER_TYPE_NONE, POS_CHECK_ORDER_TYPE_STAMP, POS_OPERATION_MODE_COUNTER, POS_OPERATION_MODE_CONFIG_KEY, POS_PRODUCT_SHOWCASE_CONFIG_KEY, resolvePosCheckOrderType, resolvePosCheckOrderTypeForShop } from '@controleonline/ui-common/src/react/config/deviceConfigBootstrap';
import { normalizeEntityId, PAYMENT_TYPE_IDS_CONFIG_KEY, PDV_PRINTER_ENABLED_CONFIG_KEY, ORDER_PAYMENT_DEVICE_CONFIG_KEY, POS_GATEWAY_CONFIG_KEY } from '@controleonline/ui-common/src/react/utils/paymentDevices';

import { PDV_TAB_MOVEMENT } from './deviceDetailConstants';
...
export default function useDeviceDetailActions(deps) {
  const {
    runtimeDevice, runtimeDeviceConfig,
